...
public class ContactContant {
	...
	public static final String FAIL_EDITTEXT_NOT_INPUT = "请选择Txt文件";
	...
	//charset
	public static final String CHARSET_GBK = "gbk";//windows
	...
	public static final int BUFFER_SIZE = 1 << 24;//移位运算
