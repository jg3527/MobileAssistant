...
public class NewTextActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_text_send);
        ...
        send_sms_button. setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(phone_number.equals("")) {
                    Toast.makeText(NewTextActivity.this, R.string.str_remind_input_phone_number, Toast.LENGTH_LONG).show();
                } else {
                    ...
                    Toast.makeText(NewTextActivity.this, R.string.str_remind_sms_send_finish, Toast.LENGTH_SHORT).show();
                }
            }     
        });
    }
