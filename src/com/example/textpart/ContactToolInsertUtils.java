...
public class ContactToolInsertUtils {
	...
	public static boolean insertIntoContact(Context context,String path,String charset){
		...
		try{
			...
			if(arrayList == null){
				Log.i("gj", "Error in insertIntoContact arrayList == null");
	...
	private static ArrayList<ContactInfo> readFromFile(String path){
		...
		if(stringsArrayList == null){
			Log.i("gj", "Error in readFromFile stringsArrayList == null");
	...
	private static ArrayList<String> doReadFile(String path){
	    ...
	    try {
            ...
            Log.i("gj","buffer size"+ContactContant.BUFFER_SIZE);
            Log.i("gj", "byte length"+tempbytes.length);
	...
	private static boolean doInsertIntoContact(Context context,ContactInfo contactInfo){
		...
		try {
			...
			Log.i("gj", "insert contact exception"+e.getMessage());
			return false;
		}
		return true;   	
	}
